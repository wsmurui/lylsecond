...
for i=1:6                 %IO信息，1:6是io口的数量，不同的电路io口数量不一样，从data文件里找有多少io口，从哪里开始这些信息来设置索引。
    iodata{i} = data{i+6};
end
logidata = {};              %逻辑连线
for i=1:9                %同上
    logidata{i} = data{i+71};  %这是加198是因为ligidata信息是从data中的第199行开始的。
end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
count.input_p = [0.5 0.5 0.5 0.4 0.7];          %每个输入为1的概率，如果你要改变各个输入口初始为1的概率就在这里改，因为
